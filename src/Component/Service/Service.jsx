...
function Service() {
  return (
    <div className='w-full px-[10%] mt-30'>
      <div className="flex flex-col gap-2 items-start text-[#02312F]"> {/* Align content to the start */}
        <h1 className='text-[24px] font-bold '>SERVICES</h1>
        <p className="max-w-[40%] text-[48px] dm">Get your dream home with expert help.</p>

        {/* Services Grid */}
        <div className="w-full flex items-end justify-between gap-8 mt-8 flex-wrap">
          {/* Card 1 */}
